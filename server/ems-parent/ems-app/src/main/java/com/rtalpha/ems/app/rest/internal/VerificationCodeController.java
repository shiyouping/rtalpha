package com.rtalpha.ems.app.rest.internal;
 ...
 *
 */
@RestController("internalVerificationCodeController")
@RequestMapping(RequestPath.API_INTERNAL_EMS_VERSION_1 + "/verificationCodes")
