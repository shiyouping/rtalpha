...
import com.rtalpha.base.email.EmailSender;
import com.rtalpha.base.kernel.utility.RandomString;
...
public class VerificationEmailServiceImpl implements VerificationEmailService {
	...
	private final EmsAppProperties properties;
	private final String sender;

	@Autowired
	public VerificationEmailServiceImpl(@Nonnull EmailSender emailSender, @Nonnull SpringTemplateEngine templateEngine,
			@Nonnull VerificationCodeService codeService, @Nonnull EmsAppProperties properties,
